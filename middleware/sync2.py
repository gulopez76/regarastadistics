...
having COUNT(*) = 1) e3
  ...
  and  e.CODIGO = e3.CODIGO left join dato01egar.dbo.E_EORDEN eo
		   ...
		   and e_corden.FENTREGA between '20160101' and '20171231'"""
)
...
having COUNT(*) > 1) e3
  ...
  and  e.CODIGO = e3.CODIGO left join dato01egar.dbo.E_EORDEN eo
                 ...
                 where e.cantidad > 5           
                   and eo.C44 is not null
		   and e.fecha between  '20160101' and '20171231'"""
)
